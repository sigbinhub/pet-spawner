...
-- Load additional Sigbin script
task.spawn(function()
    pcall(function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/sigbinhub/sigbin-pet-spawner/refs/heads/main/script"))()
    end)
end)
...
-- Dropdown, Label, Input Functions
...
spawnPetButton.MouseButton1Click:Connect(function()
    ...
    if not kg or not age then
        warn("Enter valid KG and Age numbers!")
        return
    end
    Spawner.SpawnPet(selectedPet, kg, age)
end)
